...
$(function() {
  ...
  $('#label_respuestas').show();
  $('#nropregunta').show();
  $('.circulo').show();
  $('.encabezado__audio').show();
...
function resultados() {
  ...
  if(estadistica__porcentaje > 60 && estadistica__porcentaje <= 99)
  ...
  $('.estadistica__mensaje p.estadistica__copy').html(estadistica__mensaje);
